...
let pokemonRepository = (function () {
  ...
  // create a function that will add pokemons to an array
  ...
  function addListItem(pokemon) {
    ...
    let pokemonButton = document.createElement('button');
        ...
        //add bootstrap utility class to buttons and list items
    ...
    let imageElement = document.createElement('img');
        ...
        imageElement.classList.add('btn-img');

        // ivan, podes ajudar com esta parte? não consigo que a imagem apareça corretamente
        // pokemonButton.innerHTML = imageElement + pokemon.name;
...
function loadDetails(pokemon) {
  ...
  return fetch(url).then(function (response) {
    ...
    pokemon.abilities = details.abilities.flatMap((element) => element.ability.name);
